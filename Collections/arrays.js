...
//Arrays are 0 indexed, first value will have an in index of 0, and hte last item will have an index of the array length -1
...
//Array.pop()
//Remobes the last element in our array, and it will return that element
...
shoppingList = ['celery', 'limes', 'lemons', 'salt', 'oranges']
console.log(shoppingList.includes('beef'))
...
//Array.slice()
//Slects a part of an array and returns a new array. Selects the elements starting at the provided start arguments, and ends at but does not include the provided end arguments
shoppingList = ['celery', 'limes', 'lemons', 'salt', 'oranges']
...
//Array.sort()
//Sorts the items in an array. The sort order can either be alphabetic or numeric, and either ascending or descending. By default the sort() orders the values as strings in alphabetic and ascending order. Can take in a compare function which indicates if you want to sort by ascending or descendinf values
shoppingList = ['celery', 'limes', 'lemons', 'salt', 'oranges']
...
//Array.join()
//Converts the elements of an array into a string. Can accept an optinal parameter. "Seperator", which indicates how the elements will be separated. Default separator is a comma
shoppingList = ['celery', 'limes', 'lemons', 'salt', 'oranges']
